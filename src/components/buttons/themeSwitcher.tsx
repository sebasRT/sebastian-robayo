...
const ThemeSwitcher = () => {
    ...
    return (
        <div className="absolute pointer-events-auto bottom-0 right-0 text-3xl p-2 bg-primary-100 dark:bg-primary-950 m-3 border border-primary-500 rounded-full hover:text-primary-500" onClick={toggle} title="color theme switcher">
            {
